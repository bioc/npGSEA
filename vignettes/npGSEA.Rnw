...
approximation method is the default. 
...
up-weight the genes in \verb@set7@ that had a positive fold change, 
and down-weight those with a 
negative fold change.  We assign the first 10 genes in our set a weight 
of 2, and the second 10 a weight of 0.5.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Often we want to correct for confounders in our model.  In this 
